...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Ocen model dla wybranego eksperymentu.")
...
def main() -> int:
    ...
    experiment.evaluate()
    logger.info("Ewaluacja wykonana dla eksperymentu %s.", config.experiment_name)
    return 0
